            ...
            <div>
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('surat-masuk.index') }}">Surat Keluar</a></li>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nomor" name="nomor"
                                        value="{{ @$surat_keluar->nomor ?? old('nomor') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pengirim" name="pengirim"
                                        value="{{ @$surat_keluar->pengirim ?? old('pengirim') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="waktu" name="waktu"
                                        value="{{ @$surat_keluar->waktu ?? old('waktu') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="lampiran" name="lampiran"
                                        value="{{ @$surat_keluar->lampiran ?? old('lampiran') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="perihal" name="perihal"
                                        value="{{ @$surat_keluar->perihal ?? old('perihal') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penerima" name="penerima"
                                        value="{{ @$surat_keluar->penerima ?? old('penerima') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="isi" class="col-sm-2 col-form-label">Isi Surat</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" id="isi" name="isi" required>{{ @$surat_keluar->isi ?? old('isi') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" name="id_unit_penerbit">
                                        ...
                                        @foreach ($unit_penerbit as $up)
                                            <option {{ @$surat_keluar->id_unit_penerbit == $up->id ? 'selected' : '' }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tempat" name="tempat"
                                        value="{{ @$surat_keluar->tempat ?? old('tempat') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" name="id_pengesah">
                                        ...
                                        @foreach ($pengesah as $p)
                                            <option {{ @$surat_keluar->id_pengesah == $p->id ? 'selected' : '' }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tembusan" name="tembusan"
                                        value="{{ @$surat_keluar->tembusan ?? old('tembusan') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
