...
@section('content')
    <div class="pagetitle">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="pb-2">
                <a href="{{ route('surat-masuk.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left
                "></i>
                    Kembali</a>
            </div>
        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nomor" name="nomor"
                                        value="{{ @$surat_masuk->nomor ?? old('nomor') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pengirim" name="pengirim"
                                        value="{{ @$surat_masuk->pengirim ?? old('pengirim') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="waktu" name="waktu"
                                        value="{{ @$surat_masuk->waktu ?? old('waktu') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="lampiran" name="lampiran"
                                        value="{{ @$surat_masuk->lampiran ?? old('lampiran') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="perihal" name="perihal"
                                        value="{{ @$surat_masuk->perihal ?? old('perihal') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penerima" name="penerima"
                                        value="{{ @$surat_masuk->penerima ?? old('penerima') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="isi" class="col-sm-2 col-form-label">Isi Surat</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" id="isi" name="isi" required disabled>{{ @$surat_masuk->isi ?? old('isi') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" name="id_unit_penerbit"
                                        disabled>
                                        <option selected>{{ @$surat_masuk->nama }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tempat" name="tempat"
                                        value="{{ @$surat_masuk->tempat ?? old('tempat') }}" required disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tembusan" name="tembusan"
                                        value="{{ @$surat_masuk->tembusan ?? old('tembusan') }}" required disabled>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 text-center">
                                    <a href="{{ $surat_masuk->getMedia('surat_file')->first()->getUrl() }}"
                    ...
                    <div class="class-body">
                        <div>
                            <img style="object-fit: contain;width:100%;"
                                src="{{ $surat_masuk->getMedia('surat_file')->first()->getUrl() }}"
                                alt="Surat Masuk Nomor {{ $surat_masuk->nomor }}">
                        </div>
                    </div>
                </div>
