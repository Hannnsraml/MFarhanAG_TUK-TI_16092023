<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard') }}" class="logo d-flex align-items-center">
            ...
            <span class="d-none d-lg-block">TUK TI_MFarhanAG</span>
        </a>
    ...
    <script src="{{ asset('flashjs/dist/flash.min.js') }}"></script>

    <script>
        // Initiate the Pusher JS library
        var pusher = new Pusher('b12a6c99344d2d006d23', {
            encrypted: true,
            cluster: 'ap1',
        });
        ...
        channel.bind('message-incoming', function(data) {
            ...
            refreshButton = document.querySelector('#refreshNotif');
            refreshButton.click();
            // alert(data.message.name + ' send you a message!')
            // console.table(data)
            // alert('masuk');
        });
    </script>
