<head>
    ...
    <title>{{ $title }} - TUK TI_MFarhanAG</title>

    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('assets/niceadmin/img/logo.png') }}" rel="icon">
    <link href="{{ asset('assets/niceadmin/img/logo.png') }}" rel="apple-touch-icon">
