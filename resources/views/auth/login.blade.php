                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Selamat datang di<br>Sistem Informasi UKM Poliban</h5>
                                    <p class="text-center small">Masukkan Nama / Email dan Password untuk login</p>
                                </div>
                                ...
                                <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="col-12">
                                        <label for="yourUsername" class="form-label">Nama / Email</label>
                                        <div class="input-group has-validation">
                                            {{-- <span class="input-group-text" id="inputGroupPrepend">@</span> --}}
                                            <input type="text" name="email"
                                                class="form-control @error('email') is-invalid @enderror" id="yourUsername"
                                                required placeholder="Nama / Email" value="{{ old('email') }}"
                                                autocomplete="email">
